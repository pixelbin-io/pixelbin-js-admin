...
| uploadOptions    | Object                                                                                                        | no       | Additional options for fine-tuning the upload process. Default: `{ chunkSize: 10 * 1024 * 1024, maxRetries: 2, concurrency: 3 }`                                                                                                                      |
| chunkSize        | number                                                                                                        | no       | Size of each chunk to upload. Default is 10 megabyte. Recommended chunk size for 3g network - up to 5kb, 4g network - 500kb to 1MB, 5g network - 1MB to 2MB                                                                                           |
