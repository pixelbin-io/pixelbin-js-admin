...
module.exports.getImageUrlWithOptions = function (
  url,
  pattern,
  version = "v2",
) {
...
const getTransformationsFromPattern = function (
  pattern,
  url,
  config,
  flatten = false,
...
module.exports.getUrlTransformationString = function (
  transformationList,
  config,
) {
