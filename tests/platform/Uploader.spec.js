...
describe("Uploader", () => {
    ...
    it("should support uploading from buffer", async () => {
        ...
        const axiosPostSpy = jest.spyOn(uploaderAxios, "post").mockResolvedValue(mockResponse);
    ...
    it("should retry on failure", async () => {
        ...
        const axiosPutSpy = jest
            ...
            .mockRejectedValueOnce(new PDKServerResponseError("Test Error Post", "", "", 503))
    ...
    it("should not retry on 4xx errors - chunk Upload", async () => {
        ...
        const axiosPutSpy = jest
            .spyOn(uploaderAxios, "put")
            .mockRejectedValueOnce(new PDKServerResponseError("Test Error Put", "", "", 422));
        ...
        ).rejects.toEqual(new PDKServerResponseError("Test Error Put", "", "", 422));
    ...
    it("should not retry on 4xx errors - Complete Upload", async () => {
        ...
        const axiosPostSpy = jest
            .spyOn(uploaderAxios, "post")
            .mockRejectedValueOnce(new PDKServerResponseError("Test Error Post", "", "", 422));
        ...
        ).rejects.toEqual(new PDKServerResponseError("Test Error Post", "", "", 422));
